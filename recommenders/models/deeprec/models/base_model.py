...
class BaseModel:
    ...
    def _train_opt(self):
        ...
        if optimizer == "adadelta":
            ...
            return tf.compat.v1.train.FtrlOptimizer(lr)
        elif optimizer == "padagrad":
            return tf.compat.v1.train.ProximalAdagradOptimizer(lr)
        elif optimizer == "pgd":
            return tf.compat.v1.train.ProximalGradientDescentOptimizer(lr)
    ...
    def load_model(self, model_path=None):
        ...
        """
        act_path = self.hparams.load_saved_model if model_path is None else model_path
        try:
