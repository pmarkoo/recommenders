...
def test_get_top_k_items(rating_true):
    ...
    assert set(top_3_items_df[DEFAULT_ITEM_COL][3:5]) == {1, 4}
    ...
    assert set(top_3_items_df[DEFAULT_ITEM_COL][6:]) == {2, 5, 6}
